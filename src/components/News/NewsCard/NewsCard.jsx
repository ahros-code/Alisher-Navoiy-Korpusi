  ...
  return (
      <div className={css.wrapper}>
          ...
          <div className={css.botSection}>
              ...
              <h3>{title}</h3>
              <p className={css.author}><span style={{
                  fontWeight: '500',
                  color: '#6D93A9'
              }}>Author:</span> {authors}</p>
              <p className={css.publishedDate}><span style={{
                  fontWeight: '500',
                  color: '#6D93A9'
              }}>Published at:</span> {published_at}</p>
              <button className={css.btn}><span>View more</span></button>
          </div>
      </div>
  )
}
