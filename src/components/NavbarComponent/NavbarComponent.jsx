              ...
              <Link
                ...
                className={
                  location.pathname === "/about"
                    ? css.activeDrawerItem
                    : css.notActiveDrawerItem
                }
                onClick={handleClose}
              >
        ...
        <div className={css.navbarItemsList}>
          <ul className={css.itemsList}>
            <li className={css.item}>
              <Link
                to="/about"
                className={location.pathname === "/about" ? css.activeLink : ""}
              >
                Tarjimai hol
              </Link>
            </li>
            <li className={css.item}>
              <Link
                to="/devonlar"
                className={
                  location.pathname === "/devonlar" ? css.activeLink : ""
                }
              >
                Devonlari
              </Link>
            ...
            <li className={css.item}>
              <Link
                to="/works"
                className={location.pathname === "/works" ? css.activeLink : ""}
              >
                Asarlari
              </Link>
            </li>
            <li className={css.item}>
              <Link
                to="/researches"
                className={
                  location.pathname === "/researches" ? css.activeLink : ""
                }
              >
                Ilmiy tadqiqotlar
              </Link>
            ...
            <li className={css.item}>
              <Link
                to="/korpus"
                className={
                  location.pathname === "/korpus" ? css.activeLink : ""
                }
              >
                Korpus haqida
              </Link>
